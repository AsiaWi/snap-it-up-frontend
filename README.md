...
| Saved' link from navbar- logged in                                                                           | click on saved link                                   | user directed to 'saved' page with saved adverts list                    | as expected |
| Sell !t' link from navbar- logged in                                                                         | click on sell it link from any page                   | user directed to create an advert form                                   | as expected |
| username' link from navbar- logged in                                                                        | click on username link from any page                  | user directed to own profile page                                        | as expected |
| Sign-in' link from nav bar- unauthorised                                                                     | click on sign in link from any page                   | user directed to sign in page                                            | as expected |
| Register' link from navbar- unauthorised                                                                     | click on register link from any page                  | user directed to register page                                           | as expected |
...
| Profile avatar' from advert container- any auth state                                                        | click on profile avatar from any page                 | user directed to related profile                                         | as expected |
| Profile avatar from higest rated sidebar(profile page)- any auth state                                       | click on profile avatar from sidebar                  | user directed to related profile                                         | as expected |
| Question-mark' Icon from advert container- any auth state                                                    | click on question mark icon                           | user directed to correct advert detail page                              | as expected |
| Coin icon' from advert container- any auth state                                                             | click on coins icon                                   | user directed to correct advert page                                     | as expected |
| Advert avatar' from sidebar- any auth state                                                                  | click on advert avatar                                | user directed to correct advert detail page                              | as expected |
| Reply' button from question list- logged in                                                                  | click on reply button                                 | user has now access to eply form                                         | as expected |
| {number} Reply/ies' from question list- any auth state                                                       | click on {number} repliy/ies button                   | button text changed to 'Hide {number} reply/ies' , list of replies shows | as expected |
| Hide {number} Reply/ies' from question list- any auth state                                                  | click on 'Hide {number} reply/ies' from question list | Replies list is now hidden , button text changed to '{number} Reply/ies' | as expected |
|                                                                                                              |                                                       |                                                                          |             |
| LINKS DIRECTING TO SIGN IN USER FROM CREATE FORMS- SO EVERY CASE IN UNAUTHORISED STATE                       | ACTION                                                | EXPECTED                                                                 |             |
| Questions- 'Sign in to ask a question .No questions yet'(no questions asked yet case) | user clicks on 'sign in' link                         | user directed to sign in page                                            | as expected |
| Questions-'sign in to ask a question' (questions already exist)                                              | user clicks on 'sign in' link                         | user directed to sign in page                                            | as expected |
| Offers- 'click here to sign in and make an offer!'                                                           | user clicks on 'click here' link                      | user directed to sign in page                                            | as expected |
| Offers-'Sign in to make an offer. No offers yet..' (no offers made yet case)                                 | user clicks on 'sign in' link                         | user directed to sign in page                                            | as expected |
| Ratings- 'Sign in if you want to leave a review for username'(ratings already exist)                         | user clicks on 'sign in' link                         | user directed to sign in page                                            | as expected |
| Ratings- 'admin haven't received any feedback yet. sign in to leave a review' (no ratings received yet)       | user clicks on sign in link                           | user directed to sign in page                                            | as expected |
| CHECKING CORRECT MESSAGE DISPLAYS WITHIN RATINGS TAB IF LOGGED IN USER IS PROFILE OWNER'                     | EXPECTED                                              | ACTUAL                                                                   |             |
| If ratings exist                                                                                             | \- 'Feedback you've received'                         | as expected                                                              |             |
| if no ratings received yet                                                                                   | \- 'You haven't received any feedback yet.'           | as expected                                                              |
##### Negative Testing
